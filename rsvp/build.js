...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_redux_1 = __webpack_require__(174);
	var AppContainer_1 = __webpack_require__(196);
	var react_router_1 = __webpack_require__(203);
	...
	var Main = (function (_super) {
	    ...
	    Main.prototype.render = function () {
	        return React.createElement(react_redux_1.Provider, {store: store_1.default}, React.createElement(AppContainer_1.default, null));
	    };
	    Main.contextTypes = {
	...
	var FourOhFour = (function (_super) {
	    ...
	    FourOhFour.contextTypes = {
	        router: React.PropTypes.func
	    };
	    return FourOhFour;
	}(React.Component));
	react_dom_1.render(React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, React.createElement(react_router_1.Route, {path: "/", component: Main}), React.createElement(react_router_1.Route, {path: "*", component: FourOhFour})), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "b40960f44c1402c735a3bd8824d133c0.otf";

/***/ },
/* 5 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "a8ed28bf966c88aaeebc783ca417a345.otf";
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var react_redux_1 = __webpack_require__(174);
	var App_1 = __webpack_require__(197);
	...
	var AppContainer = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(App_1.App);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppFields = (function () {
	    function AppFields() {
	    }
	    return AppFields;
	}());
	exports.AppFields = AppFields;
	exports.App = function (props) { return React.createElement("div", {className: "app"}, React.createElement("div", {className: "content"}, React.createElement("div", {className: "title debby"}, "RSVP: Billy and Rosie's Wedding"), React.createElement(Form_1.default, null)), React.createElement("div", {className: "banner"})); };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var action_2 = __webpack_require__(199);
	var CodeStatus_1 = __webpack_require__(201);
	var action_3 = __webpack_require__(199);
	var ServerClasses_1 = __webpack_require__(202);
	var ServerClasses_2 = __webpack_require__(202);
	var ServerClasses_3 = __webpack_require__(202);
	var action_4 = __webpack_require__(199);
	var action_5 = __webpack_require__(199);
	...
	exports.Form = function (props) {
	    if (props.guests.length === 0) {
	        return React.createElement("div", {className: "form"}, React.createElement("input", {className: "codeInput", onChange: props.enterCode, placeholder: "Code", value: props.code}), props.error ? React.createElement("div", {className: "error"}, props.error) : '');
	    }
	    console.log(ServerClasses_1.Attending.NOT_COMING);
	    return React.createElement("div", {className: "form"}, props.guests.map(function (guest) { return React.createElement("div", {className: "person"}, React.createElement("span", {className: "guestName"}, guest.name), (!guest.dietaryRequirements || ServerClasses_2.dietaryTypes.indexOf(guest.dietaryRequirements) != -1) ?
	        React.createElement("select", {value: guest.dietaryRequirements, onChange: props.diet.bind(null, guest)}, ServerClasses_2.dietaryTypes.map(function (dietType) {
	            return React.createElement("option", {value: dietType}, dietType);
	        }), React.createElement("option", null, "Other")) :
	        React.createElement("textarea", {onChange: props.diet.bind(null, guest), className: "dietaryText"}, guest.dietaryRequirements), React.createElement("span", {className: "attendingBox"}, React.createElement("input", {checked: guest.attending === ServerClasses_1.Attending.COMING, onChange: props.attending.bind(null, guest), type: "checkbox"}), "Attending")); }), React.createElement("input", {value: props.email, onChange: props.updateEmail, placeholder: "Email Address"}), React.createElement("div", null, "(so we can stay in touch!)"), React.createElement("button", {className: "rsvpButton", onClick: props.saveRSVP.bind(null, props.code, props.guests, props.email)}, "RSVP"));
	};
	var mapStateToProps = function (state) {
	    var error = null;
	    ...
	    else if (state.codeStatus === CodeStatus_1.CodeStatus.INCORRECT) {
	...
	var mapDispatchToProps = function (dispatch) {
	    return {
	        enterCode: function (event) {
	            ...
	            dispatch(action_1.updateCode(code));
	            if (code.length === 5) {
	                dispatch(action_2.fetchGuests(code));
	            }
	        },
	        saveRSVP: function (key, guests, email) {
	            var response = new ServerClasses_3.RSVPResponse(guests, email);
	            dispatch(action_4.sendRSVP(key, response));
	        },
	        attending: function (guest) {
	            if (guest.attending === ServerClasses_1.Attending.COMING) {
	                guest.attending = ServerClasses_1.Attending.NOT_COMING;
	            }
	            else {
	                guest.attending = ServerClasses_1.Attending.COMING;
	            }
	            dispatch(action_3.guestStateChange(guest));
	        },
	        diet: function (guest, event) {
	            guest.dietaryRequirements = event.target.value;
	            dispatch(action_3.guestStateChange(guest));
	        },
	        updateEmail: function (event) {
	            dispatch(action_5.updateEmail(event.target.value));
	        }
	    };
	};
	var FormContainer = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(exports.Form);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.UPDATE_CODE = 'CODE';
	exports.INCORRECT_CODE = 'INCORRECT_CODE';
	exports.UPDATE_GUESTS = 'UPDATE_GUESTS';
	exports.RECEIVE_GUESTS = 'RECEIVE_GUESTS';
	exports.COMPLETED_RSVP = 'COMPLETED_RSVP';
	exports.GUEST_STATE_CHANGE = 'GUEST_STATE_CHANGE';
	exports.UPDATE_EMAIL = 'UPDATE_EMAIL';
	exports.endpoint = 'http://178.62.10.96:8002/rosie/';
	function receiveGuests(guestDetails) {
	    return {
	        type: exports.RECEIVE_GUESTS,
	        payload: guestDetails
	    };
	}
	exports.receiveGuests = receiveGuests;
	function updateGuests(key, guestDetails) {
	    return {
	        type: exports.UPDATE_GUESTS,
	        payload: guestDetails
	    };
	}
	...
	function incorrectCode() {
	    return {
	        type: exports.INCORRECT_CODE
	    };
	}
	exports.incorrectCode = incorrectCode;
	function completedRSVP() {
	    return {
	        type: exports.COMPLETED_RSVP
	    };
	}
	exports.completedRSVP = completedRSVP;
	function updateEmail(email) {
	    return {
	        type: exports.UPDATE_EMAIL,
	        payload: email
	    };
	}
	exports.updateEmail = updateEmail;
	function guestStateChange(guest) {
	    return {
	        type: exports.GUEST_STATE_CHANGE,
	        payload: guest
	    };
	}
	exports.guestStateChange = guestStateChange;
	function fetchGuests(code) {
	    return function (dispatch) {
	        fetch(exports.endpoint + 'guests/', { headers: { key: code } })
	            .then(function (response) {
	            return response.json();
	        }).then(function (json) {
	            if (json.error) {
	                dispatch(incorrectCode());
	            }
	            else {
	                dispatch(receiveGuests(json.guests));
	            }
	        });
	    };
	}
	exports.fetchGuests = fetchGuests;
	function sendRSVP(code, rsvp) {
	    return function (dispatch) {
	        fetch(exports.endpoint + 'rsvp/', {
	            method: 'post',
	            body: JSON.stringify(rsvp),
	            headers: { 'Content-Type': 'application/json', key: code } })
	            .then(function (response) {
	            return response.json();
	        })
	            .then(function () {
	            alert("RSVP sent! If you don't receive a confirmation email, please contact Rosie.");
	            dispatch(completedRSVP());
	        });
	    };
	}
...
/***/ function(module, exports) {
	...
	"use strict";
	(function (CodeStatus) {
	    CodeStatus[CodeStatus["UNTRIED"] = 0] = "UNTRIED";
	    CodeStatus[CodeStatus["INCORRECT"] = 1] = "INCORRECT";
	    CodeStatus[CodeStatus["CORRECT"] = 2] = "CORRECT";
	})(exports.CodeStatus || (exports.CodeStatus = {}));
	var CodeStatus = exports.CodeStatus;
...
/***/ function(module, exports) {
	...
	"use strict";
	var RSVPResponse = (function () {
	    function RSVPResponse(rsvps, email) {
	        this.rsvps = rsvps;
	        this.email = email;
	    }
	    return RSVPResponse;
	...
	(function (Attending) {
	    Attending[Attending["NOT_RESPONDED"] = 0] = "NOT_RESPONDED";
	    Attending[Attending["COMING"] = 1] = "COMING";
	    Attending[Attending["NOT_COMING"] = 2] = "NOT_COMING";
	})(exports.Attending || (exports.Attending = {}));
	var Attending = exports.Attending;
	var GuestObject = (function () {
	    function GuestObject(name, attending, dietaryRequirements) {
	        this.name = name;
	...
	var ServerResponse = (function () {
	    function ServerResponse(error, guests) {
	        this.error = error;
	        this.guests = guests;
	    }
	...
	exports.dietaryTypes = ["None", "Vegetarian", "Vegan"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var redux_thunk_1 = __webpack_require__(265);
	var redux_1 = __webpack_require__(181);
	var initialState_1 = __webpack_require__(266);
	var reducer_1 = __webpack_require__(267);
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = redux_1.createStore(reducer_1.default, initialState_1.default, redux_1.applyMiddleware(redux_thunk_1.default));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    guests: [],
	    code: "",
	    codeStatus: CodeStatus_1.CodeStatus,
	    loading: false,
	    email: ""
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	__webpack_require__(268).polyfill();
	var action_1 = __webpack_require__(199);
	var action_2 = __webpack_require__(199);
	var action_3 = __webpack_require__(199);
	var action_4 = __webpack_require__(199);
	var CodeStatus_1 = __webpack_require__(201);
	var action_5 = __webpack_require__(199);
	var action_6 = __webpack_require__(199);
	var action_7 = __webpack_require__(199);
	function rosie(state, action) {
	    switch (action.type) {
	        case action_5.UPDATE_CODE:
	            return Object.assign({}, state, { code: action.payload, codeStatus: CodeStatus_1.CodeStatus.UNTRIED });
	        case action_1.INCORRECT_CODE:
	            return Object.assign({}, state, { codeStatus: CodeStatus_1.CodeStatus.INCORRECT });
	        case action_2.UPDATE_GUESTS:
	            return Object.assign({}, state, { loading: true });
	        case action_3.RECEIVE_GUESTS:
	            return Object.assign({}, state, { guests: action.payload });
	        case action_4.COMPLETED_RSVP:
	            return Object.assign({}, state, { loading: false });
	        case action_7.UPDATE_EMAIL:
	            return Object.assign({}, state, { email: action.payload });
	        case action_6.GUEST_STATE_CHANGE:
	            var newGuests = state.guests.map(function (guest) {
	                if (guest.name === action.payload.name) {
	                    return action.payload;
	                }
	                return guest;
	            });
	            return Object.assign({}, state, { guests: newGuests });
	        default:
	            return state;
	    }
	}
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = rosie;
